...
roomType.type AS bookRoomName
 FROM `roomType`,`booking` WHERE roomType.id =booking.room');
...
<h3 class="text-center">Panelden Elave Olunan Rezervasiyalar</h3>
    ...
    <div class="dropdown show">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <a class="dropdown-item" href="changerezervation.php?id=<?php echo $rez['bookid']; ?>"><button class="btn btn-warning">Değiştir</button></a>
